  ...
  return (
    <PageShell title="我的" description="账户、订单和会员服务入口。">
      <View className="page-shell__section">
        <View className="page-shell__section-title">{rootStore.session.user?.nickname || '未登录'}</View>
        <View className="page-shell__muted">
          {rootStore.session.user?.mobile || '登录后可管理订单、游客和会员权益'}
        </View>
      </View>
