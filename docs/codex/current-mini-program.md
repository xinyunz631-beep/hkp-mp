...
- 2026-06-16 已按后端 `origin/uat@abbe80b` 建立小程序优惠券 BFF 必须接口清单；2026-06-18 00:01 复核 `origin/uat@6e52c67`，源码已补 CRM 会员券实例与 promotion 会员券资产同源同步。当前阻塞从“源码同源未补”转为“缺目标券号严格探针、`available` 商品/SKU/日期入参和退款返还精确幂等口径”。
