...
- 点击筛选应切换列表。
- 编辑态点击选规格、分享、删除，应分别进入商品详情、出现分享引导、弹删除确认。
...
### v0.4-detail-sku-entry

- 收藏页不再直接写购物车，选中商品后进入商品详情，由详情页承接完整规格选择。

### v0.3-interaction-ready

- 收藏编辑态从占位提示升级为详情选规格、微信分享和删除确认。
